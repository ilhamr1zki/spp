<?php  
    ...
    if ($timeRunningOut == $timeOut || $timeRunningOut > $timeOut) {
        ...
        $dataPasswordLama   = mysqli_query($con, "SELECT * FROM admin WHERE c_admin = '$_SESSION[c_admin]' "); 
        ...
        if (password_verify($dataInputPasswordLama, $getPassword)) {
            ...
            if (strlen($dataInputPasswordBaru) < 5 || strlen($dataInputKonfirmasiPassword) < 5) {
                ...
                if ($dataInputPasswordBaru == $dataInputKonfirmasiPassword) {
                    ...
                    mysqli_query($con, "UPDATE admin SET password = '$generatePassword' WHERE c_admin = '$_SESSION[c_admin]' ");
