          ...
          <tbody>
            ...
            <?php foreach ($dataSiswa as $data): ?>
              ...
              <tr>
                ...
                <td id="button_act">
                  <form action="<?= $basead; ?>editdatasiswa" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control form-select" id="kelas" name="kelas">
                      ...
                      <?php foreach ($jenjang_pendidikan as $data): ?>
                        <option value="<?= $data['c_kelas']; ?>" <?= ($data['c_kelas'] == $jenjangSiswa) ? 'selected="selected"' : '' ; ?> > <?= $data['kelas']; ?> </option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            function refreshPage() {
              location.replace(`<?= $basead; ?>editdatasiswa`)
            }
