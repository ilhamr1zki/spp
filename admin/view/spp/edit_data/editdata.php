<?php  
    ...
    $iniScrollBackSaveHapus = "kosong";
    $iniScrollBackPage      = "kosong";
    $pageActive = 0;

    $currentPage        = 0;

    $queryNamaInputer  = "SELECT username FROM admin WHERE c_admin = '$_SESSION[c_admin]' ";
    ...
    if ($_SESSION['c_admin'] == 'adm1') {
    	...
    	$dataSiswa = mysqli_query($con, "
            SELECT ID, NAMA, PANGGILAN, NIS, KELAS FROM data_murid_sd
            UNION 
            SELECT ID, NAMA, PANGGILAN, NIS, KELAS FROM data_murid_tk
            ORDER BY KELAS ASC
        ");	
    ...
    if (isset($_POST['filter_by_edit'])) {
        ...
        if ($id != '' && $nis != '' && $namaSiswa != '' && $kelas != '' && $panggilan != '') {
            ...
            if ($_POST['isi_filter_edit'] != 'kosong') {
                ...
                // Data Semua
                elseif ($_POST['isi_filter_edit'] == 'SEMUA') {

                    if ($dariTanggal != " 00:00:00" && $sampaiTanggal != " 23:59:59") {
                        $setSesiPageFilterBy = 15;
                    } elseif($dariTanggal == " 00:00:00" && $sampaiTanggal == " 23:59:59") {
                        $setSesiPageFilterBy = 8;
                    }
    ...
    elseif (isset($_POST['edit_data'])) {
        ...
        // DATA PEMBAYARAN
        if ($typeFilter == 'SPP' || $typeFilter == 'PANGKAL' || $typeFilter == 'KEGIATAN' || $typeFilter == 'BUKU' || $typeFilter == 'SERAGAM' || $typeFilter == 'REGISTRASI' || $typeFilter == 'LAIN' || $typeFilter == 'SEMUA') {
    ...
    elseif (isset($_POST['hapus_data_pembayaran'])) {
        ...
        $currentFilter   = htmlspecialchars($_POST['currentFilter']);
        $isifilby        = $currentFilter;

        $halamanAktif   = $_POST['currentPage'];

        $iniScrollBackSaveHapus   = "ada";
        $setSesiPageFilterBy = 8;
        ...
        $_SESSION['form_success'] = "data_delete";
    }
    ...
    // PAGINATION SEMUA
    elseif (isset($_POST['nextPageFilterSemua'])) {
    ...
    elseif (isset($_POST['previousPageFilterSemua'])) {
    ...
    elseif (isset($_POST['toPageFilterSemua'])) {
    ...
    elseif (isset($_POST['nextPageFilterSPP'])) {
        ...
        if ($_SESSION['c_admin'] == 'accounting1') {
    ...
    elseif (isset($_POST['nextPageFilterSPPWithDate'])) {
        ...
        } elseif ($_SESSION['c_admin'] == 'accounting2') {
    ...
    elseif (isset($_POST['firstPageFilterPANGKAL'])) {
        ...
        } else if ($_SESSION['c_admin'] == 'accounting2') {
    ...
    <?php else: ?>
        ...
        <div class="box box-info">
            ...
            <?php elseif($setSesiPageFilterBy == 8): ?>
                <?php require 'form_edit_pembayaran_semua.php'; ?>
            ...
            <?php elseif($setSesiPageFilterBy == 15): ?>
                <?php require 'form_edit_pembayaran_semua_with_date.php'; ?>
            <?php endif; ?>  
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        function redirectPage() {
            document.location.href = `<?= $basead; ?>editdata`
        }
        ...
        let scrollBackSaveHapus   = `<?= $iniScrollBackSaveHapus; ?>`
