<?php 
    ...
    if ($code_accounting == 'accounting1') {
            ...
            if ($_POST['isi_filter'] != 'kosong' ) {
                ...
                // SERAGAM
                    ...
                    if ($dariTanggal == " 00:00:00" && $sampaiTanggal == " 23:59:59") {
                        ...
                        // echo $dataAwal . "<br>";
                        $ambildata_perhalaman = mysqli_query($con, "
                            SELECT ID, NIS, NAMA, kelas, SERAGAM, TRANSAKSI, BULAN AS pembayaran_bulan, SERAGAM_txt, STAMP AS tanggal_diupdate, INPUTER AS di_input_oleh 
                            FROM input_data_sd
                            WHERE
                            SERAGAM != 0
                            AND NAMA LIKE '%$namaMurid%' 
                ...
                // LAIN
                    ...
                    if ($dariTanggal == " 00:00:00" && $sampaiTanggal == " 23:59:59") { 
                        ...
                        // echo $dataAwal . "<br>";
                        $ambildata_perhalaman = mysqli_query($con, "
                            SELECT ID, NIS, NAMA, kelas, LAIN, TRANSAKSI, BULAN AS pembayaran_bulan, LAIN_txt, STAMP AS tanggal_diupdate, INPUTER AS di_input_oleh 
                            FROM input_data_sd
                            WHERE
                            LAIN != 0
                            AND NAMA LIKE '%$namaMurid%' 
        ...
        if (isset($_POST['toPage'])) {
            ...
            if ($_POST['isi_filter'] != 'kosong' ) {
                ...
                // SEMUA
                    ...
                    if ($dariTanggal == " 00:00:00" && $sampaiTanggal == " 23:59:59") {
                        ...
                        $dataAwal = ($halamanAktif * $jumlahData) - $jumlahData;
                        // echo $dataAwal . "<br>";
                        $ambildata_perhalaman = mysqli_query($con, "SELECT * FROM input_data_tk WHERE NAMA LIKE '%$namaMurid%' ORDER BY STAMP DESC LIMIT $dataAwal, $jumlahData");
            ...
            $ambildata_perhalaman = mysqli_query($con, "
                SELECT * FROM input_data_tk WHERE NAMA LIKE '%$namaMurid%' ORDER BY STAMP DESC LIMIT $dataAwal, $jumlahData
            ");
