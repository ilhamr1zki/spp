    ...
    if ($timeRunningOut == $timeOut || $timeRunningOut > $timeOut) {
                        ...
                        if ($currentFilter == 'SPP') {
                            ...
                            if ($pembayaranVIA == 'kosong') {
                                ...
                                $queryUpdate = "
                                    ...
                                    `PANGKAL`='$nominalBayarPangkal',
                                    `PANGKAL_txt`='$ketPembayaranPangkal',
                                    `REGISTRASI`='$nominalBayarSeragam', 
                                    `REGISTRASI_txt`=NULL, 
                                    `TRANSAKSI`=NULL,
                                    `INPUTER`='$getNamaInputer',
                                    `STAMP`='$data_stamp'
        ...
        elseif (isset($_POST['simpan_tambah_edit'])) {
            ...
            if ($data_ket_spp == '') {
                ...
                $data_ket_spp       = mysqli_real_escape_string($con, htmlspecialchars($_POST['ket_uang_spp_edit']));
                // echo $data_ket_spp . " ";
            }
            ...
            if ($data_ket_pangkal == '') {
                ...
                $data_ket_pangkal       = mysqli_real_escape_string($con, htmlspecialchars($_POST['ket_uang_pangkal_edit']));
            ...
            if ($data_ket_kegiatan == '') {
                ...
                $data_ket_kegiatan       = mysqli_real_escape_string($con, htmlspecialchars($_POST['ket_uang_kegiatan_edit']));
            ...
            if ($data_ket_buku == '') {
                ...
                $data_ket_buku       = mysqli_real_escape_string($con, htmlspecialchars($_POST['ket_uang_buku_edit']));
                // echo $data_ket_buku . " ";
            }
            ...
            if ($data_ket_seragam == '') {
                ...
                $data_ket_seragam       = mysqli_real_escape_string($con, htmlspecialchars($_POST['ket_uang_seragam_edit']));
            ...
            if ($data_ket_registrasi == '') {
                ...
                $data_ket_registrasi       = mysqli_real_escape_string($con, htmlspecialchars($_POST['ket_uang_regis_edit']));
